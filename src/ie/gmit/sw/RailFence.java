...
public class RailFence {
	...
	// file with some plain text - read it in 
	// encrypt it
	// Decypher it 
	   // init cypher breaker - parsing 4grams.txt into a hash map
	   // creating via for loop multiple producer threads that add to blocking queue
	      // resultable, result etc... TextScorer to give each one 
	   // one consumer thread that takes the highest scoring item and print to screen
